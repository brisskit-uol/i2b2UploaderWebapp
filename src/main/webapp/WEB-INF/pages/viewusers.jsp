			...
			<div class="container-fluid">
				...
				<div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right">
						...
						<li><a href="http://wiki.brisskit.le.ac.uk/wiki/I2b2_Uploader_Portal_Guide" target="_blank">Help</a></li>
					</ul>
				</div>
			</div>
		</nav>
								...
								<div>
									<ul>
										<c:forEach var="listValue" items="${users}">
											<li>${fn:substring(listValue.username, 0, 4)}....</li>
										</c:forEach>
									</ul>
								</div>
							</c:if>
