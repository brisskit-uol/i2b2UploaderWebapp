...
<title>Brisskit Portal - Change Password</title>
			...
			<div class="row">
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="row">
						<div class="col-xs-4">
							<c:if test="${pageContext.request.userPrincipal.name != null}">				
				Change password for ${pageContext.request.userPrincipal.name}. Please enter new password 			
			</c:if>
							<br> <br>
							<form id="cu" class="form" name='loginChangeForm'
								action="<c:url value='/passwordchanged' />" method='POST'
								autocomplete="off">
								<!-- <input type="password" class="form-control"  autocomplete='off' id='curPassword' name='curPassword' placeholder="Current Password" required autofocus>  -->
								<input type="password" class="form-control" autocomplete='off'
									id='newPassword1' name='newPassword1'
									placeholder="New Password" required autofocus> <input
									type="password" class="form-control" autocomplete='off'
									id='newPassword2' name='newPassword2'
									placeholder="New Password Again" required autofocus> <input
