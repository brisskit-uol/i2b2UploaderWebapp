			...
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="i2b2instance">Your i2b2
								instance</a></li>
					</ul>
				</div>
				...
				<div class="col-md-10 col-md-offset-2 main">
					...
					<!-- amazon jboss vm -->
					<c:if test="${not empty i2b2url}">
		   				<iframe class="embed-responsive-item" src="/i2b2/webclient_brisskit"  width="100%" height="550px" seamless="seamless" align="left"></iframe>
						<a href="/i2b2/webclient_brisskit" target="_blank">open i2b2 in new window</a>
					</c:if>
  					
					
					<!-- laptop 
					<c:if test="${not empty i2b2url}">
						<iframe class="embed-responsive-item" src="${i2b2url}" width="100%" height="550px" seamless="seamless" align="left"></iframe>
						<a href="${i2b2url}" target="_blank">${i2b2url}</a>
					</c:if>
					-->
				</div>
			</div>
