			...
			<div class="row">
				<div class="col-sm-3 col-md-2 sidebar">
					<ul class="nav nav-sidebar">
						...
						<li class="active"><a href="deleteproject">Delete Project</a></li>
				...
				<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
					...
					<div class="row">
						<div class="col-xs-4">
							...
							<form method="GET" action="<c:url value='deleteproject' />">
								...
								<select class="form-control" id="project_name"
									...
									class="btn btn-primary" type="submit" value="Delete"> <input
